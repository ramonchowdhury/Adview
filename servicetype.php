      ...
      <div class="card-columns">
        ...
        if(isset($_GET["setpage"])){
          ...
          $start = 0;
				...
				$getType = $_GET['type'];
				$query = "SELECT * FROM `ads` WHERE `type` = '$getType'  LIMIT $start,$limit";
				$query_run = mysqli_query($con,$query);
	        ...
	        <div class="card bg-secondary">
	          ...
	          <div class="card-body">
	            <h4 class="card-title bg-dark text-warning p-2 text-center rounded text-uppercase"><?php echo $result['title']?></h4>
		 ...
		 ?>
             ...
             <nav class="mt-5 pt-3">
              <ul class="pagination justify-content-center">
                  <?php
                    $query = "SELECT * FROM `ads` WHERE `type` = '$getType'";
                    ...
                    if($count > 0)
                      for($i=1;$i<=$pageno;$i++){
                        if(isset($_GET["setpage"])){
                          if($_GET['setpage']==$i){
                            echo "<li class='page-item'><a href='servicetype.php?servicetype=".$getType."&setpage=".$i."' class ='active page-link'>$i</a></li> ";

                          }
                          else{
                            echo "<li class='page-item'><a href='servicetype.php?servicetype=".$getType."&setpage=".$i."' class='page-link'>$i</a></li> ";
                          }
                        }
                        else{
                          echo "<li class='page-item'><a href='servicetype.php?servicetype=".$getType."&setpage=".$i."' class='page-link'>$i</a></li> ";
