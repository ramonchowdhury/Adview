...
if(!isset($_SESSION['usernameewxyn']) || empty($_SESSION['usernameewxyn'])) {
  ...
  $query = "INSERT INTO ads (username, category, title, name, type, location, phone, image1, image2, image3, discription, directory) VALUES ('$username', '$category', '$title', '$name_', '$gtype', '$location', '$phone', '$image1', 'Null', 'Null', '$message', '$str1')";
...
<!-- postyourads -->
  ...
  <div class="contact1">
    <div class="container-contact1">
      ...
      <form action="adhometutor.php" method="post" enctype="multipart/form-data" class="contact1-form validate-form">
        <span class="contact1-form-title">
          Fill Up the from to publish your post
        </span>
        <div class="wrap-input1 validate-input">
          <input class="input1"  name="title" placeholder="Title">
          <span class="shadow-input1"></span>
        </div>
        <div class="wrap-input1 validate-input">
          <select class="input1" name="gtype">
                   <option selected calss="default">Select Gender</option>
                   <option>Male</option>
        ...
        <div class="wrap-input1 validate-input">
          <input class="input1" type="text" name="phone" placeholder="Contact Number">
          <span class="shadow-input1"></span>
        </div>


        <div class="wrap-input1 validate-input">
          <input class="input1" type="file" name="image1" placeholder="" required="">
          <span class="shadow-input1"></span>
        </div>
        ...
        <div class="container-contact1-form-btn">
          <button class="contact1-form-btn" name="post">
            <span>
              Post
