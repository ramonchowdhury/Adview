      ...
      <div class="card-columns">
        ...
        if(isset($_GET["setpage"])){
          ...
          $start = 0;
				...
				$query = "SELECT * FROM `ads` WHERE `location` = '$getLocation' LIMIT $start,$limit";
				$query_run = mysqli_query($con,$query);
	        ...
	        <div class="card bg-secondary ">
	          ...
	          <div class="card-body effect">
	            <h4 class="card-title bg-secondary text-dark p-2 rounded text-uppercase text-center"><?php echo $result['title']?></h4>
		 ...
		 ?>
             ...
             <nav class="mt-5 pt-3">
              <ul class="pagination justify-content-center">
                  <?php
                    $query = "SELECT * FROM `ads` WHERE `location` = '$getLocation'";
                    ...
                    if($count > 0)
                      for($i=1;$i<=$pageno;$i++){
                        if(isset($_GET["setpage"])){
                          if($_GET['setpage']==$i){
                            echo "<li class='page-item'><a href='location.php?location=".$getLocation."&setpage=".$i."' class ='active page-link'>$i</a></li> ";

                          }
                          else{
                            echo "<li class='page-item'><a href='location.php?location=".$getLocation."&setpage=".$i."' class='page-link'>$i</a></li> ";
                          }
                        }
                        else{
                          echo "<li class='page-item'><a href='location.php?location=".$getLocation."&setpage=".$i."' class='page-link'>$i</a></li> ";
