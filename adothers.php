...
if(!isset($_SESSION['usernameewxyn']) || empty($_SESSION['usernameewxyn'])) {
  ...
  $query = "INSERT INTO ads (username, category, title, name, type, location, phone, price, image1, image2, image3, discription, directory) VALUES ('$username', '$category', '$title', '$name_', '$getType', '$location', '$phone', '$price', '$image1', '$image2', '$image3', '$message', '$str1')";
...
<!-- postyourads -->
  ...
  <div class="contact1">
    <div class="container-contact1">
      ...
      <form action="adothers.php" method="post" enctype="multipart/form-data" class="contact1-form validate-form">
